...
from devopcollab.core.views import core
from devopcollab.users.views import users
from devopcollab.blog_posts.views import blog_posts
from devopcollab.error_pages.handlers import error_pages
